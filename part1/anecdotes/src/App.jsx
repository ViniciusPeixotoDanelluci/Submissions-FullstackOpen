...
function App() {
  ...
  const handleVote = () => {
    const newVotes = [...votes] /*creates a new array with the same values as votes*/
    newVotes[selected] += 1 /*modify the value of the selected anecdote using the copy array*/
    setVotes(newVotes)
  }
